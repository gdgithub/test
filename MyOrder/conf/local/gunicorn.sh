...
NAME="MyOrder"                    # Name of the application
DJANGODIR=../src/                 # Django project directory
SOCKFILE=../../run/gunicorn.sock  # we will communicte using this unix socket
USER=gildevelopers                # the user to run as
GROUP=webapp                      # the group to run as
NUM_WORKERS=3                     # how many worker processes should Gunicorn spawn
DJANGO_SETTINGS_MODULE=main.settings.local # which settings file should Django use
