	...
	$(".signUp").click(function(e){
		...
		if(validate($(".rcorreo"),"value"))
		{
			if(validate($(".rcorreo"),"email")){
				...
				{
					sweetAlert("Las contraseñas no coinciden", "Introduzca la contraseña nuevamente.", "error");
					return false;
				}
				...
				sweetAlert("Dominio de correos incorrecto.", "Debe registrarse utilizando su cuenta de “@intellisys.com.do” o “@cincinnatus.com.do”", "error");
			}
		}
		else{
			sweetAlert("Campo vacio", "Debe completar todos los campos para realizar el registro.", "error");
		}
