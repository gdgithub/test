						...
						getMenuCategories(function(data){
							...
							for(var j=0; j<categories.length; j++)
							{
								...
								for(var d=0; d<menu_content[categories[j]].length; d++)
								{
									...
									//html += `<div class="menu_row_details"><input type="number" class="menu_cant_details" ><span class="menu_desc">`+menu_content[categories[j]][d].desc+`</span>  <span class="mp">$<span class="menu_price">`+menu_content[categories[j]][d].price+`</span></span></></div><br>`;
									...
									//html += `<div class="menu_row_details"><span class="menu_desc">`+menu_content[categories[j]][d].desc+`</span>  <span class="mp">$<span class="menu_price">`+menu_content[categories[j]][d].price+`</span></span></div>`;
